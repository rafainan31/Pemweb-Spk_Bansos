export const scoringOptions: Record<string, { label: string; score: number }[]> = {
  pendapatanBulanan: [
    { label: '> Rp2.500.000', score: 1 },
    { label: 'Rp1.500.001 - Rp2.500.000', score: 2 },
    { label: 'Rp1.000.001 - Rp1.500.000', score: 3 },
    { label: 'Rp500.001 - Rp1.000.000', score: 4 },
    { label: '≤ Rp500.000', score: 5 }
  ],
  dayaListrik: [
    { label: '> 2200 VA', score: 1 },
    { label: '2200 VA', score: 2 },
    { label: '1300 VA', score: 3 },
    { label: '900 VA', score: 4 },
    { label: '450 VA', score: 5 }
  ],
  jenisDinding: [
